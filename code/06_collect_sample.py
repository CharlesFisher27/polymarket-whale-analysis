"""
06_collect_sample.py — Collect data for the stratified market sample and
...
Usage:
    ...
    python code/06_collect_sample.py --sample /tmp/final_sample.json
    python code/06_collect_sample.py --skip-existing
"""
...
def collect_market(market: dict, event_comments_cache: dict,
    ...
    # price pre-filter removed — collect all markets regardless of price range

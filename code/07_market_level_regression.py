"""
07_market_level_regression.py — Cross-market regression: whale effect vs market volume.
...
Usage:
    python code/07_market_level_regression.py
    python code/07_market_level_regression.py --rebuild   # force rebuild of effects table
"""
...
MIN_EVENTS     = 10    # minimum events for a market to be included
